    ...
    return (
        <div className="section offwhitebg">
            <div className="content">
                ...
                <h2 className="underline">Team and buddy meetings</h2>
                ...
                <h2 className="underline">Expenses</h2>
                ...
                <h2 className="underline">Mileage</h2>
                ...
                <h2 className="underline">Holiday and leave</h2>
                ...
                <h2 className="underline">Sickness and absence</h2>
